...
public class IntelligenceAdapter extends BaseAdapter {
    ...
    private Context c;
    public IntelligenceAdapter(Context c, List<Intelligence_information> intelligence_list) {
        this.c = c;
    ...
    public View getView(final int position, View convertview, ViewGroup viewGroup) {
        convertview = myInflater.inflate(R.layout.intelligence_object_list, viewGroup, false);
        TextView title = (TextView) convertview.findViewById(R.id.intelligence_textView_title);
        TextView price = (TextView) convertview.findViewById(R.id.intelligence_textView_price);
        TextView ID = (TextView) convertview.findViewById(R.id.intelligence_textView_ID);
        //ImageView heart = (ImageView)  convertview.findViewById(R.id.intelligence_ImageView_icon);
        TextView popularity = (TextView) convertview.findViewById(R.id.intelligence_textView_popularity);
        TextView department = (TextView) convertview.findViewById(R.id.intelligence_textView_department);
